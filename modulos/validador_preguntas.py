...
class ValidadorPreguntas:
    ...
    def lematizar(self, termino: str) -> str:
        """Lematiza un término. Usa NLTK + mapa manual para español.
        
        Integrado 2026-09-11 sin romper la federación.
        """
        try:
        ...
        # Mapa manual para español (NLTK es inglés-first)
        MAPA_ES = {
            "deudores": "deuda",
            "deudoras": "deuda",
            "deudas": "deuda",
        ...
        try:
            ...
            return t  # fallback si falta wordnet
